...
| `cube-10x10-open.stl` | Hand-authored for this repo (ASCII STL, item 9) | The same cube with its +z face removed — 10 triangles. Deliberately open, so the volume sum returns 666.67 mm³ (1000 − the origin-to-face pyramid) while the bounding box still measures a perfect 10 mm cube. The fixture for the open-mesh warning: a part that looks fine and whose density weight is 33% wrong. |
