...
// to ADR-0003. This is a *planning/triage* workflow — it decides WHERE effort,
...
const adrPath = (typeof args === 'string' ? args : args && args.adr) || 'doc/adr/0003-packing-modes-and-tiers.md'
  ...
  properties: {
    slices: {
      ...
      items: {
        ...
        properties: {
          id: { type: 'string', description: 'short kebab-case id, e.g. obb-rotation-search' },
          title: { type: 'string' },
