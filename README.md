...
<p align="center">
  <a href="https://github.com/LoganBresnahan/Carton-Fit/releases/latest"><strong>Version 1.2.0</strong></a>
  &nbsp;·&nbsp;
...
- **Windows** — `Carton-Fit-Setup-1.2.0.exe` (NSIS installer). The build is
  currently unsigned, so SmartScreen will warn on first run; choose "More info"
  → "Run anyway".
- **Linux** — `Carton-Fit-1.2.0-linux.AppImage`; make it executable and run it.
